...
ui <- fluidPage(
  ...
  navbarPage(title="Menu",id="selectedTab",
             tabPanel(title="Map",
             ...
             tabPanel(title="Number of Cases",
                      sidebarLayout(
                        sidebarPanel(
                        ...
                        mainPanel(box(plotlyOutput(metaData@tab_settings[[2]]$label[2])),
                                  div(id = "SaveLoad",downloadButton(metaData@tab_settings[[2]]$label[3], 
                                                                     metaData@tab_settings[[2]]$title[3])))
                      )),
             tabPanel(title="Cost",
                      sidebarLayout(
                        sidebarPanel(
                        ...
                        mainPanel(box(plotlyOutput(metaData@tab_settings[[3]]$label[2])),
                                  div(id = "SaveLoad",downloadButton(metaData@tab_settings[[3]]$label[3], 
                                                                     metaData@tab_settings[[3]]$title[3])))
                      )),
             tabPanel(title="About",
                      includeMarkdown(paste0("./static_data/", metaData@tab_settings[[4]]$markdownFile)),
                      imageOutput(metaData@tab_settings[[4]]$label[2])),
